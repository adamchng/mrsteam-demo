	...
	<div id="main" class="controls product-page">
		...
		<div class="wrapper">
			...
			<?php before_option_box(); ?>
				...
				<div class="title">Steam bath accessories a' la carte</div>
...
<table border="1">
	<tr>
		<td><input type="radio" value="notnow" rowspan="4">Not right now</td>
	<td></td>
	<td></td>
	<td></td>
	<td></td>
...
<tr>
<td></td>
		<td align="center"><input type="radio">Drip Pan</td>
		<td align="center"><input type="radio">Auto Flush</td>
		<td align="center"><input type="radio">Steam Genie</td>

</tr>
	<tr>
		<td></td>
		<td><img src="images/products/drippan.png" id="options" alt="drip pan"></td>
		<td><img src="images/products/autoflush.png" id="options" alt="auto flush"></td>
		<td><img src="images/products/steam-genie.png" id="options" alt="steam genie"></td>	
	</tr>
</table>
</div>
